                                ...
                                Expanded(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                        colors: [
                                          Color(0xFFff7052).withOpacity(0.3),
                                          Color(0xFFff7052),
                                        ],
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        iconCircle(Color(0xFFff7bbd), "Send Money",
                            Icons.attach_money),
                        iconCircle(
                            Color(0xFF6db4e0), "Accounts", Icons.account_box),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        iconCircle(Color(0xFFfeb885), "Statement", Icons.store),
                        iconCircle(Color(0xFFfeb0d8), "History", Icons.history),
                        iconCircle(
                            Color(0xFF5788f1), "Management", Icons.settings),
                      ],
                    )
                  ],
                ),
